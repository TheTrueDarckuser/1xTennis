            ...
            try:
                ...
                for game in games:
                    ...
                    for match in matches:
                        ...
                        while 1:
                            try:
                                liveData[liga][name] = {'firstKoef': firstKoef, 'secondKoef': secondKoef, 'timeAdd': time.time(), 'timeStart':timeStart, 'total': total, 'totalL':totalL,'totalM':totalM,
                                                        'idT1L':idT1L,'idT1':idT1, 'idT1M':idT1M,
                                                        'idT2L':idT2L,'idT2':idT2, 'idT2M':idT2M,
...
while 1:
    try:
        ...
        browser.get('https://1x-bet93029.com/ru/line/Tennis/')
        sleep(5)
        offCompactView()
        lineData = getLive()
        browser.quit()
